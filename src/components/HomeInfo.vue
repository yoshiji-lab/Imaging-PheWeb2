<template>
    ...
    <v-alert
        ...
        border="top"
    >
    This tool is designed to provide the community with a comprehensive overview of GWAS and PheWAS results from our genomic atlas of imaging-derived phenotypes, including cardiac MRI and DXA-derived adiposity. For detailed information on phenotype definitions, data quality control, and analytical pipelines, please refer to our paper. <strong>All summary statistics will be available for download upon acceptance of the manuscript.</strong> If you have any questions, please reach out using the contact details provided on our <a href="contact">Contact page</a>.
    </v-alert>
